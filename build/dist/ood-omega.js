...
angular.module('OODLib').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('lib/footer/footer.html', '<footer><span class="leftFooter">Copyright © {{model.data.year}} {{model.data.name}}<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>Version: {{model.data.version}} {{model.data.status}}</span><span class="rightFooter"> <ul> <li ng-repeat="(k, v) in model.data.website"><a ng-href="{{ v }}">&nbsp;&nbsp;{{ k }}&nbsp;&nbsp;|</a></li> </ul></span></footer>');
