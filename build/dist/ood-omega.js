...
angular.module('OODLib').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('lib/footer/footer.html', '<footer><span class="copyright">Copyright © {{model.data.year}} {{model.data.name}} | Version: {{model.data.version}} {{model.data.status}}</span><span class="help"><span ng-repeat="(k, v) in model.data.website"><a ng-href="{{ v }}">&nbsp;{{ k }}&nbsp;</a>|</span></span></footer>');
